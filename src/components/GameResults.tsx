...
export function GameResults({ players, onPlayAgain, onBackToLobby }: GameResultsProps) {
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Button
            onClick={onPlayAgain}
            className="h-14 bg-red-500 hover:bg-red-600 border-2 border-black text-white text-lg"
          >
